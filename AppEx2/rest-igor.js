...
app.get('/api/boolean/simplify/:expression', (req, res) => { // anonymous function
  console.log("GET request received for /api/boolean/simplify/%s", req.params.expression);
